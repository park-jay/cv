...
\noindent \textbf{Park, J.} \& Cordell, R. (2025). A data-driven investigation of euphemistic language: Comparing the usage of ``slave'' and ``servant'' in 19th century US newspapers. \textit{NLP4DH 2025}. \hfill \href{https://github.com/park-jay/slavery-discourse}{Code} \href{https://aclanthology.org/anthology-files/anthology-files/pdf/nlp4dh/2025.nlp4dh-1.31.pdf}{Paper}\\
...
\noindent \textbf{Park, J.}, Yoon, A. (forthcoming). Characteristics of Dataset and Model Reuse Patterns on the Hugging Face Platform. \textit{The 88th Annual Meeting of the Association for Information Science and Technology (ASIS\&T).} \hfill \\
